...
export function Skill({ SkillIcon, level}: Props) {
  ...
  return (
    ...
    <div className='group relative flex cursor-pointer'>
      <CustomTag className=' border border-gray-500 object-cover w-20 h-20 max-[320px]:w-16 max-[320px]:h-16 filter group-hover:grayscale transition duration-300 ease-in-out'/>

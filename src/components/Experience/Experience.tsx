    ...
    return (
        <motion.div
            ...
            <div className='w-full flex space-x-5 overflow-x-scroll p-10 scrollbar scrollbar-track-gray-400/20 scrollbar-thumb-[#fafafa]/80 max-[320px]:mt-10'>
                ...
                <ExperienceCard cover={aws} job={"AWS re/Start"} company={"Escola da Nuvem"} skill="aws" time={"05/2023 - O momento"} summaryPoint={["Treinamento e desenvolvimento para carreira na nuvem", "Conteúdo teórico e laboratórios práticos"]}/>

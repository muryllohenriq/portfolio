    ...
    return (
        <motion.div
            ...
            <div className='w-full flex space-x-5 overflow-x-scroll p-10 scrollbar scrollbar-track-gray-400/20 scrollbar-thumb-[#fafafa]/80 max-[320px]:mt-10'>
                ...
                <ExperienceCard cover={iecLogo} job={"Voluntário"} company={"IEC"} skill="ts,vite,react,styledcomponents,git" time={"07/12/2022 - o momento"} summaryPoint={["Desenvolvimento e estilização de páginas estáticas"]}/>
            </div>
        </motion.div>
    )
}
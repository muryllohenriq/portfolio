    ...
    return (
        <motion.div
            ...
            <div className='w-full flex space-x-5 overflow-x-scroll p-10 snap-x snap-mandatory scrollbar scrollbar-track-gray-400/20 scrollbar-thumb-[#fafafa]/80'>
                <ExperienceCard cover='https://avatars.githubusercontent.com/u/105292489?v=4' job={"Freelancer"} company={"My self"} skill="js,html" time={"Inicio... - Término..."} summaryPoint={["summarypoint", "SummaryPoints", "oi", "hello"]}/>
                <ExperienceCard cover='https://avatars.githubusercontent.com/u/105292489?v=4' job={"Freelancer"} company={"My self"} skill="js,html" time={"Inicio... - Término..."} summaryPoint={["summarypoint", "SummaryPoints", "oi", "hello"]}/>
            </div>
        </motion.div>
    )

...
export function ExperienceCard({cover, job, company, skill, time, summaryPoint}: Props) {
  ...
  return (
    <>
    <article className='flex flex-col rounded-lg items-center space-y-2 flex-shrink-0 w-[500px] h-[450px] mt-20 max-[320px]:h-[305px] md:w-[600px] md:h-[600px] xl:w-[500px] xl:h-[550px] snap-center bg-[#292929] p-6 hover:opacity-100 opacity-40 cursor-pointer transition-opacity duration-200 overflow-hidden'>
        <motion.img 
        initial={{
            y: -100,
            opacity: 0,

...
export function ExperienceCard({cover, job, company, skill, time, summaryPoint}: Props) {
  ...
  return (
    <>
    <article className='flex flex-col rounded-lg items-center space-y-2 flex-shrink-0 w-[500px] h-[450px] mt-20 max-[320px]:h-[305px] md:w-[600px] md:h-[600px] xl:w-[500px] xl:h-[550px] snap-center bg-[#292929] p-10 hover:opacity-100 opacity-40 cursor-pointer transition-opacity duration-200 overflow-hidden'>
        <motion.img 
        initial={{
            y: -100,
            opacity: 0,
        ...
        viewport={{ once: true }}
        className='w-28 h-28 rounded-full max-[320px]:-mt-5 xl:w-[130px] xl:h-[130px] object-cover object-center' src={cover} 
        alt="" />

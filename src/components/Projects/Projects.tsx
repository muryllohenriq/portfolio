        ...
        <>
            <motion.div
                ...
                <div className="relative w-full flex overflow-x-scroll overflow-y-hidden snap-x snap-mandatory z-20 scrollbar-thin scrollbar-track-gray-400/20 scrollbar-thumb-[#fafafa]/80">
                    <ProjectCard deploy='https://ecommerce-mh.vercel.app' repo='https://github.com/muryllohenriq/ecommerce-muryllohenriq' cover={ecommerceIcon} tag='E-Commerce' name='MH Ecommerce' skills={[SiNextdotjs, SiReact, GrStripe]} summary='E-commerce desenvolvido com react e nextjs na criação da aplicação, sanity como o backend e stripe para o sistema de pagamentos. A estilização foi feita com CSS puro.' shadowColor='hover:shadow-[0_0_25px_#664b42]' underlineColor='decoration-[#664b42]'/>
